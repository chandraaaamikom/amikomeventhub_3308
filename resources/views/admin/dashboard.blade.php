    ...
    <header class="flex justify-between items-center mb-10">
        ...
        <div class="flex items-center gap-4">
            <div class="text-right hidden md:block">
                <p class="font-bold">{{ Auth::user()->name ?? 'Admin Super' }}</p>
            ...
            <div class="w-12 h-12 bg-white rounded-2xl shadow-sm border flex items-center justify-center p-1">
                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name ?? 'Admin Super') }}&background=6366f1&color=fff"
                    class="rounded-xl">
            </div>
        </div>
    </header>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-8 py-10 text-center text-slate-500 font-semibold">
